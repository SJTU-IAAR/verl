...
def xverify_qa_evaluation(solution_str: str, 
    ...
    try:
        ...
        if isinstance(ground_truth, dict) and 'target' in ground_truth:
            gt_str = str(ground_truth['target'])
...
def compute_score(solution_str: str, 
    ...
    if do_print:
        print(f"======== ENHANCED XH PANG SEARCH REWARD DEBUG (10% sample) ========")
        ...
        print(f"Search patterns: search={search_count}, code={code_count}, answer={answer_count}, execution={execution_count}")
